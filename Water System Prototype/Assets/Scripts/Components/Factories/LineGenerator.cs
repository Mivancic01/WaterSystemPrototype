...
public class LineGenerator : MonoBehaviour
{
    ...
    public void SetNode(Vector3 nodePos, string nodeID)
    {
    ...
    public GameObject CreateAndReturnLineComponent(Vector3 startNode, Vector3 endNode, int typeID, float diameter)
    {
        if (!GameStateManager.Instance.createPath)
            return null;
    ...
    private void CreateSymbol()
    {
        ...
        var zPos = (endPosition.z - startPosition.z) / 2;
        Vector3 pos = new Vector3(xPos + startPosition.x, startPosition.y, zPos + startPosition.z
            );
    ...
    private void CreateLineObject(Vector3 startPos)
    {
        ...
        {
            case 1:
                line = Instantiate(pipePrefab, startPos, Quaternion.Euler(90, 0, 0));
                break;
            case 2:
                line = Instantiate(pumpPrefab, startPos, Quaternion.Euler(90, 0, 0));
                break;
            case 5:
                line = Instantiate(valvePrefab, startPos, Quaternion.Euler(90, 0, 0));
                break;
            default:
                Debug.LogError("INVALID NODE TYPE!");
                break;
